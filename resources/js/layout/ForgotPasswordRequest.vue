            ...
            async reset(){
                ...
                try{
                  ...
                  switch(error.response.status){
                    ...
                    this.enableSubmitiion(this.$refs.btnSubmit)
                    this.isLogging = false
            },

            disableSubmitiion(btn){
                btn.setAttribute('disable', 'disable');
                this.btnOldHtml = btn.innerHtml;
                btn.innerHtml = '<h4>Please wait</h4>';
            },
            enableSubmitiion(btn){
                btn.removeAttribute('disable', 'disable');
                this.btnOldHtml = btn.innerHtml;
            },
